...
<div class="container my-3">
    ...
    <form action="{{route('admin.categories.store',$catalog->slug)}}" method="post">
        @csrf
        <div class="mb-3">
            <label for="name" class="form-label">Category Name</label>
            <input type="text" class="form-control" name="name" id="name" aria-describedby="categoryNameHelp" placeholder="" />
